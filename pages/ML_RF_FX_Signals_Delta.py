...
def build_feature_matrix(df_ohlc, alpha, beta, delta_pt):
    ...
    # use only prior-day features to avoid same-day leakage
      ...
      <div style="display:flex; justify-content:space-between; align-items:center;">
        <div>
          ...
          <p style="color:#9CA3AF; font-size:0.85rem; margin-top:0.15rem;">
            Train a Random Forest to predict hitting a same-bar profit target (Δ), then overlay it on the α–β strategy as an ML filter.
          </p>
        </div>
...
st.markdown(
    ...
    <div class="section-header">
      ...
      <p>RandomForest classifier predicting same-bar profit target hit (High ≥ (1+Δ)·Open).</p>
    </div>
    """,
    unsafe_allow_html=True,
)
